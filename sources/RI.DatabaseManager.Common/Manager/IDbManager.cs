...
namespace RI.DatabaseManager.Manager
{
    ...
    /// <remarks>
    ///     <para>
    ///         A database manager encapsulates low-level database management functionality so that high-level database
    ///         functionality (such as repositories, Entity Framework contexts, Dapper, etc.) can be used on top without having
    ///         to worry about database management (e.g. versioning).
    ///         A database manager is intended to handle all low-level database management, such as connection and database
    ///         creation, versioning, migration, backup, etc., so that the high-level functionality can focus on the actual
    ///         task of working with the data.
    ///     </para>
    ///     <para>
    ///         The link from the database manager to higher-level functionality are the database connections and/or
    ///         transactions which can be created using <see cref="CreateConnection" /> and <see cref="CreateTransaction" />.
    ///     </para>
    ///     <para>
    ///         Batches (<see cref="IDbBatch" />) can be used to group multiple commands (<see cref="IDbBatchCommand" />) into
    ///         one unit.
    ///         Some dependencies (e.g. version detectors) might use batches to retrieve the commands required to execute their
    ///         functionality.
    ///     </para>
    ///     <para>
    ///         The database cannot be used if it is in any other state than <see cref="DbState.ReadyUnknown" />,
    ///         <see cref="DbState.ReadyNew" />, or <see cref="DbState.ReadyOld" />.
    ///         However, there are a few exceptions:
    ///         Cleanups (<see cref="Cleanup" />) and Upgrades (<see cref="Upgrade(int)" />,
    ///         <see cref="IDbManagerExtensions.Upgrade" />) are also possible in the <see cref="DbState.New" /> state.
    ///         Backups (<see cref="Backup" />) and Restores (<see cref="Restore" />) are possible in any state except
    ///         <see cref="DbState.Uninitialized" />.
    ///     </para>
    ///     <note type="note">
    ///         A database manager, and all its dependencies, makes no assumptions or requirements regarding the used threading
    ///         model.
    ...
    public interface IDbManager : IDisposable
    {
        ...
        /// <remarks>
        ///     <note type="implement">
        ///         <see cref="SupportsBackup" /> should be set during the construction of the database manager and then remain
        ///         unchanged and independent of the current database state or version (only depending on the database manager
        ///         configuration).
        ///     </note>
        /// </remarks>
        ...
        /// <remarks>
        ///     <note type="implement">
        ///         <see cref="SupportsCleanup" /> should be set during the construction of the database manager and then remain
        ///         unchanged and independent of the current database state or version (only depending on the database manager
        ///         configuration).
        ///     </note>
        /// </remarks>
        ...
        /// <remarks>
        ///     <note type="implement">
        ///         <see cref="SupportsCreate" /> should be set during the construction of the database manager and then remain
        ///         unchanged and independent of the current database state or version (only depending on the database manager
        ///         configuration).
        ///     </note>
        /// </remarks>
        ...
        /// <remarks>
        ///     <note type="implement">
        ///         <see cref="SupportsReadOnlyConnections" /> should be set during the construction of the database manager and
        ///         then remain unchanged and independent of the current database state or version (only depending on the database
        ...
        /// <remarks>
        ///     <note type="implement">
        ///         <see cref="SupportsRestore" /> should be set during the construction of the database manager and then remain
        ///         unchanged and independent of the current database state or version (only depending on the database manager
        ///         configuration).
        ///     </note>
        /// </remarks>
        ...
        /// <remarks>
        ///     <note type="implement">
        ///         <see cref="SupportsUpgrade" /> should be set during the construction of the database manager and then remain
        ///         unchanged and independent of the current database state or version (only depending on the database manager
        ///         configuration).
        ///     </note>
        /// </remarks>
        ...
        /// </summary>
        /// <param name="backupTarget">
        ///     The backup creator specific object which abstracts the backup target (e.g. a stream or a
        ///     path to a file).
        /// </param>
        /// <returns>
        ...
        /// <remarks>
        ///     <note type="implement">
        ///         <see cref="State" /> and <see cref="Version" /> are updated to reflect the state and version of the database
        ///         after backup.
        ///     </note>
        /// </remarks>
        /// <exception cref="ArgumentNullException"> <paramref name="backupTarget" /> is null. </exception>
        /// <exception cref="ArgumentException">
        ///     <paramref name="backupTarget" /> is of a type which is not supported by the
        ///     configured <see cref="IDbBackupCreator" />.
        /// </exception>
        /// <exception cref="InvalidOperationException"> The database is not initialized. </exception>
        /// <exception cref="NotSupportedException">
        ///     Backup is not supported by the database manager or no
        ///     <see cref="IDbBackupCreator" /> is configured.
        /// </exception>
        ...
        /// <exception cref="NotSupportedException">
        ///     Cleanup is not supported by the database manager or no
        ///     <see cref="IDbCleanupProcessor" /> is configured.
        /// </exception>
        bool Cleanup ();
        ...
        /// <remarks>
        ///     <note type="implement">
        ///         <see cref="State" /> and <see cref="InitialState" /> are set to <see cref="DbState.Uninitialized" />,
        ///         <see cref="Version" /> and <see cref="InitialVersion" /> are set to -1.
        ///     </note>
        ///     <note type="implement">
        ...
        /// <exception cref="NotSupportedException">
        ///     Creation is not supported by the database manager or no
        ///     <see cref="IDbCreator" /> is configured.
        /// </exception>
        bool Create ();
        ...
        /// <exception cref="NotSupportedException">
        ///     <paramref name="readOnly" /> is true but read-only connections are not
        ///     supported or the specified <paramref name="isolationLevel" /> is not supported.
        /// </exception>
        ...
        /// <param name="detectVersionAndStateAfterExecution">
        ///     Specifies whether the databases version and state (
        ///     <see cref="Version" /> and <see cref="State" />) should be updated after execution of the batch.
        /// </param>
        /// <returns>
        ...
        /// <remarks>
        ///     <note type="implement">
        ///         <see cref="State" />, <see cref="Version" />, <see cref="InitialState" />, <see cref="InitialVersion" /> are
        ///         updated to reflect the current state and version of the database after initialization.
        ///     </note>
        ///     <note type="implement">
        ///         Details about failures should be written to logs.
        ///     </note>
        ...
        ///     The backup creator specific object which abstracts the backup source (e.g. a stream or a
        ///     path to a file).
        /// </param>
        /// <returns>
        ...
        /// <exception cref="ArgumentException">
        ///     <paramref name="backupSource" /> is of a type which is not supported by the
        ///     configured <see cref="IDbBackupCreator" />.
        /// </exception>
        /// <exception cref="InvalidOperationException"> The database is not initialized. </exception>
        /// <exception cref="NotSupportedException">
        ///     Restore is not supported by the database manager or no
        ///     <see cref="IDbBackupCreator" /> is configured.
        /// </exception>
        ...
        ///         specified by <paramref name="version" />, is reached.
        ///     </note>
        /// </remarks>
        /// <exception cref="ArgumentOutOfRangeException">
        ///     <paramref name="version" /> is less than <see cref="MinVersion" />,
        ///     greater than <see cref="MaxVersion" />, or less than <see cref="Version" />.
        /// </exception>
        /// <exception cref="InvalidOperationException"> The database is not in a ready state. </exception>
        /// <exception cref="NotSupportedException">
        ...
        where TParameterTypes : Enum
    {
        ...
        bool ExecuteBatch (IDbBatch<TConnection, TTransaction, TParameterTypes> batch, bool readOnly,
