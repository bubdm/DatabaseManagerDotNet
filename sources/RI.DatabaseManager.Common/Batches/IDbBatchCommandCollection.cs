...
namespace RI.DatabaseManager.Batches
{
    ...
    public interface IDbBatchCommandCollection <TConnection, TTransaction, TParameterTypes> : IDbBatchCommandCollection,
        IList<IDbBatchCommand<TConnection, TTransaction, TParameterTypes>>
