...
{
    /// <summary>
    ///     Default implementation of <see cref="IDbBatchCommandParameterCollection" /> and
    ///     <see cref="IDbBatchCommandParameterCollection{TParameterTypes}" /> suitable for most scenarios.
    /// </summary>
    /// <typeparam name="TParameterTypes"> The database command parameter type. </typeparam>
    /// <threadsafety static="false" instance="false" />
    public sealed class
        DbBatchCommandParameterCollection <TParameterTypes> : IDbBatchCommandParameterCollection<TParameterTypes>
        where TParameterTypes : Enum
    {
        #region Instance Properties/Indexer

        private HashSet<IDbBatchCommandParameter<TParameterTypes>> InternalSet { get; } =
            new HashSet<IDbBatchCommandParameter<TParameterTypes>>();
        ...
        {
            DbBatchCommandParameterCollection<TParameterTypes> clone =
        ...
        #region Interface: ICollection<IDbBatchCommandParameter<TParameterTypes>>
        ...
        /// <inheritdoc />
        void ICollection<IDbBatchCommandParameter<TParameterTypes>>.
            Add (IDbBatchCommandParameter<TParameterTypes> item) =>
        ...
        /// <inheritdoc />
        public void CopyTo (IDbBatchCommandParameter<TParameterTypes>[] array, int arrayIndex) =>
        ...
        #region Interface: IDbBatchCommandParameterCollection
        ...
        public bool Contains (string name) =>
            this.InternalSet.Any(x => x.Name.Equals(name, StringComparison.InvariantCultureIgnoreCase));
        ...
        {
            IDbBatchCommandParameter<TParameterTypes> parameter =
                this.InternalSet.FirstOrDefault(x => x.Name.Equals(name, StringComparison.InvariantCultureIgnoreCase));
        ...
        #region Interface: IDbBatchCommandParameterCollection<TParameterTypes>
        ...
        public IDbBatchCommandParameter<TParameterTypes> Add (string name, TParameterTypes type, object value = null)
        {
            ...
            DbBatchCommandParameter<TParameterTypes> parameter =
                new DbBatchCommandParameter<TParameterTypes>(name, type, value);
        ...
        #region Interface: IEnumerable<IDbBatchCommandParameter<TParameterTypes>>

        /// <inheritdoc />
        public IEnumerator<IDbBatchCommandParameter<TParameterTypes>> GetEnumerator () =>
            this.InternalSet.GetEnumerator();
        ...
        #region Interface: ISet<IDbBatchCommandParameter<TParameterTypes>>
