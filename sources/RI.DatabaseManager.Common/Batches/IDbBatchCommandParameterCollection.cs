...
namespace RI.DatabaseManager.Batches
{
    ...
    /// <remarks>
    ///     <para>
    ///         The parameters contained in <see cref="IDbBatchCommandParameterCollection" /> must be unique, distinguished by
    ///         their names (<see cref="IDbBatchCommandParameter.Name" />).
    ///     </para>
    /// </remarks>
    ...
    public interface IDbBatchCommandParameterCollection <TParameterTypes> : IDbBatchCommandParameterCollection,
                                                                            ISet<IDbBatchCommandParameter<
                                                                                TParameterTypes>>
