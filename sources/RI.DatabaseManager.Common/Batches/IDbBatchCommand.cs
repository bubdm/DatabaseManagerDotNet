...
namespace RI.DatabaseManager.Batches
{
    ...
    public interface IDbBatchCommand : ICloneable
    {
        ...
        /// </summary>
        /// <value>
        ///     The database provider specified error of the last execution of this command or null if the command was not executed
        ...
        /// </summary>
        /// <value>
        ///     The exception of the last execution of this command or null if the command was not executed or no exception was
        ///     thrown.
        /// </value>
