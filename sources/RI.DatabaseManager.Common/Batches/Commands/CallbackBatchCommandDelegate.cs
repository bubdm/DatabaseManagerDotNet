...
namespace RI.DatabaseManager.Batches.Commands
{
    ...
    /// </returns>
    public delegate object CallbackBatchCommandDelegate (DbConnection connection, DbTransaction transaction, IDbBatchCommandParameterCollection parameters, out string error, out Exception exception);
    ...
    ///     The result of the code callback.
    /// </returns>
    public delegate object CallbackBatchCommandDelegate <TConnection, TTransaction, TParameterTypes> (TConnection connection, TTransaction transaction, IDbBatchCommandParameterCollection<TParameterTypes> parameters, out string error, out Exception exception)
