...
namespace RI.DatabaseManager.Batches
{
    ...
    public static class IDbBatchCommandExtensions
    {
        ...
        public static DbBatchCommandParameterCollection<TParameterTypes>
            MergeParameters <TConnection, TTransaction, TParameterTypes> (
                this IDbBatchCommand<TConnection, TTransaction, TParameterTypes> command,
            ...
            where TParameterTypes : Enum
        {
            ...
            DbBatchCommandParameterCollection<TParameterTypes> merged =
