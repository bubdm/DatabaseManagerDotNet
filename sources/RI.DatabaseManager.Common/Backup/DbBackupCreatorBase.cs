...
{
    /// <summary>
    ///     Boilerplate implementation of <see cref="IDbBackupCreator" /> and
    ///     <see cref="IDbBackupCreator{TConnection,TTransaction,TParameterTypes}" />.
    /// </summary>
    ...
    /// <remarks>
    ///     <note type="implement">
    ///         It is recommended that database backup creators implementations use this base class as it already implements
    ///         most of the database-independent logic defined by <see cref="IDbBackupCreator" /> and
    ///         <see cref="IDbBackupCreator{TConnection,TTransaction,TParameterTypes}" />.
    ///     </note>
    /// </remarks>
    /// <threadsafety static="false" instance="false" />
    public abstract class
        DbBackupCreatorBase <TConnection, TTransaction, TParameterTypes> : IDbBackupCreator<TConnection, TTransaction,
            TParameterTypes>
        ...
        where TParameterTypes : Enum
    {
        ...
        bool IDbBackupCreator.Backup (IDbManager manager, object backupTarget) =>
            this.Backup((IDbManager<TConnection, TTransaction, TParameterTypes>)manager, backupTarget);

        /// <inheritdoc />
        bool IDbBackupCreator.Restore (IDbManager manager, object backupSource) =>
            this.Restore((IDbManager<TConnection, TTransaction, TParameterTypes>)manager, backupSource);
        ...
        /// <inheritdoc />
        public abstract bool Backup (IDbManager<TConnection, TTransaction, TParameterTypes> manager,
                                     object backupTarget);

        /// <inheritdoc />
        public abstract bool Restore (IDbManager<TConnection, TTransaction, TParameterTypes> manager,
                                      object backupSource);
